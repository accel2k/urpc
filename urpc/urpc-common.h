...
#ifndef __URPC_COMMON_H__
#define __URPC_COMMON_H__
...
typedef struct _uRpcHeader uRpcHeader;
struct _uRpcHeader
{
...
typedef struct _uRpcSHMControl uRpcSHMControl;
struct _uRpcSHMControl
{
