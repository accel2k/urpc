...
#define URPC_STATUS_OK                     0x00000000  /*!< Выполнено. */
#define URPC_STATUS_FAIL                   0x00010000  /*!< Общая ошибка. */
#define URPC_STATUS_TRANSPORT_ERROR        0x00020000  /*!< Ошибка при передаче данных. */
#define URPC_STATUS_VERSION_MISMATCH       0x00030000  /*!< Не совпадают версии протоколов. */
#define URPC_STATUS_AUTH_ERROR             0x00040000  /*!< Ошибка при проверке аутентификации. */
